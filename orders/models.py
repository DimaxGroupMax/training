...
class Order(models.Model):
    ...
    is_payd = models.BooleanField(default=False, verbose_name='Оплачено')
...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(to=Products, on_delete=models.SET_NULL, null=True, verbose_name='Продукт', default=None)
